...
//	}
	...
	public LexicalDFA constructDFAfromLex(RegularExpr expr) {
		Iterator<String> itr = expr.getWordTypeNamesItr();
		while (itr.hasNext()) {
			String type = itr.next();
			
			LexicalDFA lexicalFA = new LexicalDFA(expr.getRegularEntry(type), type);
		}
		return null;
	}
